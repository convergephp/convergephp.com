<section class="mx-auto max-w-7xl p-6 py-16 md:py-24 lg:px-8">
    ...
    <div data-aos="fade-up"
        ...
        <div class="text-4xl/[1.07] font-bold tracking-tight md:text-5xl/[1.07]">
            <span class="from-base-content bg-gradient-to-br to-gray-500 bg-clip-text text-transparent">
    ...
    <div class="mt-16 grid grid-cols-6 gap-4 lg:grid-cols-12 lg:gap-6 xl:gap-8">
        ...
        <div data-aos="fade-up"
             data-aos-duration="2000"
             class="bg-base-300/80 group order-1 col-span-full flex h-[480px] flex-col overflow-hidden rounded-2xl ring-1 ring-gray-400/50 md:col-span-3 lg:col-span-5 xl:col-span-4">
            <div class="mb-4 h-full w-full overflow-hidden [mask:linear-gradient(transparent,primary,transparent)]">
            ...
            <div class="mt-auto w-full space-y-4 px-8 pb-8">
                <h3 class="text-base-content text-lg/none font-semibold">
                    Customizable Themes
                </h3>
                <p class="text-base-content/80 max-w-sm text-sm">
        ...
        <div data-aos="fade-up"
            ...
            <div class="mt-auto w-full space-y-4 px-8 pb-8">
                ...
                <p class="text-base-content/80 max-w-md text-sm xl:max-w-sm">
        ...
        <div data-aos="fade-up"
            ...
            <div class="mt-auto w-full space-y-4 px-8 pb-8">
                <h3 class="text-base-content text-lg/none font-semibold">Views interception</h3>
                <p class="text-base-content/80 max-w-sm text-sm">
