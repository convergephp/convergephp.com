...
<ul  class="timeline not-prose timeline-compact timeline-snap-icon timeline-vertical bg-base-200 rounded-box mx-auto  w-full  lg:py-3"> 
    <li class="lg:gap-x-6">
        <div class="timeline-middle"><svg xmlns="http://www.w3.org/2000/svg"
             viewBox="0 0 20 20"
             fill="currentColor"
             class="text-{{ $color }} h-5 w-5">
        ...
        <hr class="{{ $color ? 'bg-' . $color : 'bg-transparent' }}">
    </li>
</ul>
