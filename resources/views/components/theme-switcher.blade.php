<div {{ $attributes }}
    ...
    <button type="button"
            ...
            class="border-base-300 focus:ring-base-300 relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border border-2 border-gray-400/20 transition-colors duration-200 ease-in-out focus:outline-none focus:ring-1 focus:ring-offset-0"
            :class="isDark ? 'bg-gray-400/20' : 'bg-gray-50'"
            role="switch"
            :aria-checked="isDark">

        <span class="bg-base-200 pointer-events-none relative inline-block h-5 w-5 transform rounded-full shadow ring-0 transition duration-200 ease-in-out"
            ...
            <span class="absolute inset-0 flex h-full w-full items-center justify-center transition-opacity"
                ...
                <x-iconsax-bul-moon class="h-4 w-4" />
            </span>
        </span>
    </button>
</div>
