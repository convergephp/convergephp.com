...
<div data-aos="fade-right"
     ...
     {{ $attributes->merge(['class' => 'border-x-(--pattern-fg) dark:[--pattern-fg:var(--color-white)]/10  row-span-full row-start-1 my-2 h-12 border-x bg-[image:repeating-linear-gradient(315deg,_var(--pattern-fg)_0,_var(--pattern-fg)_1px,_transparent_0,_transparent_50%)] bg-[size:10px_10px] bg-fixed [--pattern-fg:var(--color-base-300)] md:col-start-3 md:block']) }}>
